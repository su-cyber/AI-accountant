# app.py - Fixed version with CrossEncoderWrapper fix
import os
import re
import time
import pdfplumber
...
# Fix for sentence_transformers compatibility
from transformers import AutoTokenizer, AutoModelForSequenceClassification
import torch

load_dotenv()

app = FastAPI(title="Financial Compliance Checker API")
    ...
    def predict(self, pairs, batch_size=16):
        ...
        for i in range(0, len(pairs), batch_size):
            ...
            with torch.no_grad():
                ...
                # FIX: Use the correct logit dimension for this model
                # This model outputs a single score (relevance probability)
...
def process_compliance_job(job_id: str, checklist_path: str, pdf_path: str):
    ...
    try:
        ...
        # Load checklist
        checklist = load_and_prepare_checklist(checklist_path)
...
async def upload_files(
    ...
    background_tasks.add_task(process_compliance_job, job_id, checklist_path, pdf_path)
